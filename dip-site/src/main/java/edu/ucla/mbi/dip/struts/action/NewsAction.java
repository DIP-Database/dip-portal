 ...
 * $Id:: NewsAction.java 3174 2013-05-23 16:54:24Z zplat                       $
 * Version: $Rev:: 3174                                                        $
 *==============================================================================
 *                                                                             $
...
public class NewsAction extends ManagerSupport {
    ...
    public JsonContext getMenuContext() {
        ...
        if( super.getMenuContext() != null ) return super.getMenuContext();
        return super.getPortalContext().getSiteMenu( this.site ); 
    }
