 ...
 <BODY onLoad="self.name='DIP_MA'; self.focus()">
  ...
  <center>
   ...
   <table width="100%" cellspacing="5" cellpadding="5" border="0">
    <tr>
     <s:form action="record">
       <td width="40%" align="right"> 
         DIP Accession: <s:textfield theme="simple" name="ac"  label="Accession"/>
       </td>
       <td width="10%">  
       ...
       <td width="10%">  
         |<s:checkbox theme="simple" name="jsonOn" label="JSON" value="false" fieldValue="true"/> JSON |
       </td>
