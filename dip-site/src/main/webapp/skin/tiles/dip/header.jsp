   ...
   <table width="100%" cellspacing="0" border="0">
    <tr>
     <td class="logo" valign="middle">
      <a href="/"><img height="55" border="0" src="images/dip_logo_2_sm55.png" alt="DIP"/></a>
     </td>
    </tr>
   </table>
  </td>
...
<iframe id="yui-history-iframe" src="images/dip_logo_2_sm55.png" style="
    position: absolute;  top:0; left:0;  width:1px; height:1px; /* avoid scrollbars */  visibility:hidden;
"></iframe>   
