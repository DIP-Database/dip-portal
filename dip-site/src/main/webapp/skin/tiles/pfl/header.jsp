   ...
   <table width="100%" cellspacing="0" border="0">
    <tr>
     <td class="logo" valign="middle">
      <a href="./"><img height="55" border="0" src="images/prl_header_5sm.png" alt="PFL"/></a>
     </td>
    </tr>
   </table>
  </td>
         ...
         <s:if test='#mpos.count==menuSel[0]'>
          <td class="menu1select" nowrap>
           <a onMouseOver="this.className='mmMON'" onMouseOut="this.className='mmMOFF'" 
              class="topmenulinkon" HREF="<s:property value='[0].link' />">
         ...
         <s:else>
          <td class="menu1" nowrap>      
           <a onMouseOver="this.className='MON'" onMouseOut="this.className='MOFF'" 
              class="topmenulink" HREF="<s:property value='[0].link' />">
         ...
         <table cellspacing="0" cellpadding="0">
          <tr>
           ...
           <s:if test="searchOn">
            ...
            <form action="php_query" method="post">

             <a onMouseOver="this.className='bmMON'" onMouseOut="this.className='bmMOFF'"
                class="btmmenulink" 
	        onclick="YAHOO.mbi.modal.help( 'Query syntax', 'pl_help_solr_search' ); return false" 
                href="">?</a>

             <input type="text" name="input" size="24" maxlength="128" value="" id="query"/>
