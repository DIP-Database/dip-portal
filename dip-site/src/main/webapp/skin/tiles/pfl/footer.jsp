       ...
       <td width="1%" class="imexfooter">
        <table align="center" cellpadding="4" cellspacing="0">
         <tr>
          ...
          <td>
           <i>
            <A HREF="page?id=pl_acknowledgements">Acknowledgements</A>
           </i>
          </td>
         </tr>
        </table>
...
--%>
       ...
       <td width="1%" class="contact">
        <table align="center" cellpadding="4" cellspacing="0">
               <tr>
                ...
                <td>
                 <nobr><i>Send questions/comments to</i></nobr><br/>
                 <a href="mailto:prolinks@mbi.ucla.edu"><i>prolinks@mbi.ucla.edu</i></a>
                </td>
               </tr>
        </table>
       </td>
      ...
      <tr>
       <td class="copyright2" colspan="2" nowrap>
        <b>Copyright ${prolinks.copyright} UCLA</b>
        [<A HREF="page?id=pl_acknowledgments">Acknowledgments</A>]
