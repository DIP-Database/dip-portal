...
<table width="98%" cellspacing="10">
 <tr>
  <td align="left" colspan="2">
   ...
   <A HREF="mailto:<s:property value='adminMail' escapeHtml='false'/>"><s:property value='adminMail' escapeHtml='false'/></A>
   <br/> 
  </td>
 </tr>
 <tr>
  <td colspan="1" align="center">
   <s:form action="dip/feedback" theme ="simple" includeContext="false">
       <s:hidden name="captchaResponse" value=""/>
    <table width="96%">
     <tr>
      <s:if test="about.length() > 0">
       <th width="10%" align="right" nowrap>Comments on:</th>
     ...
     <tr>
      <td align="left" colspan="2">
       <s:submit name="submit" value="Submit"
                 onclick="YAHOO.util.Dom.get('dip_feedback_captchaResponse').value = grecaptcha.getResponse()"/>
      </td>
     </tr>
    </table>
   </s:form>
