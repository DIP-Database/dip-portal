...
YAHOO.mbi.accordion = {
    ...
    open : function() {
        ...
        if(accordionObjects.length > 0) {
            ...
            YAHOO.util.Dom.addClass( headers[0], "selected" );            
            var body = YAHOO.util.Dom.getNextSibling( headers[0] );
            YAHOO.util.Dom.addClass( body, "open");
            YAHOO.util.Dom.removeClass( body ,"close");
        }
    },
