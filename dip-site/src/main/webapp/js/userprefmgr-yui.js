...
YAHOO.mbi.userprefmgr = {
    ...
    init: function( init ){
        ...
        try{
            YAHOO.util.Connect
            .asyncRequest( 'GET', userprefmgr.viewUrl, callback );        
        } catch (x) {
    ...
    htmlMenu: function( name, opp, value ){
        ...
        menuButton.on( "selectedMenuItemChange", 
                               YAHOO.mbi.userprefmgr.onMenuItemClick );
    ...
    defset: function( o ){
        ...
        try{
            ...
            YAHOO.util
                .Connect.asyncRequest( 'GET', userprefmgr.defsetUrl, 
                                       callback );        
        } catch (x) {
            console.log("AJAX Error:"+x);
        }
