...
<script src="js/protein-summary-yui.js" type="text/javascript" language="JavaScript"></script>
<script src="js/article-summary-yui.js" type="text/javascript" language="JavaScript"></script>
<script src="js/evidence-summary-yui.js" type="text/javascript" language="JavaScript"></script>
<script src="js/interaction-summary-yui.js" type="text/javascript" language="JavaScript"></script>
 ...
 <s:if test="summary!=null">
  <tr>
   <td class="pagebody_record"> 
       <t:insertDefinition name="recordviewbody" />
   </td>
  </tr>
 </s:if>
 <s:else>
