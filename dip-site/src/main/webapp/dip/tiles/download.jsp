...
<table class="pagebody" width="100%" cellpadding="0" cellspacing="0">
 ...
 <tr>
  <td class="page">
   <div style="padding:0 0 10em 1em; width: 80em;">
    <table width="100%">
     <tr>
      <td align="left">  
     ...
     <%-- tabs: level 0 --%>
       ...
       <table width="99%" align="center" cellspacing="0">
        <tr>
         <s:iterator value="tabData.tab0" var="tab" status="mpos0" > 
       ...
       <tr>
         <s:if test="tabData.tab1.size > 0">
          ...
          <td colspan="<s:property value='tabData.tab0.size+1'/>" class="t0cont">
           <table width="99%" align="center" cellspacing="0">
            <tr>
             <s:iterator value="tabData.tab1" tab="tab" status="mpos1" >
