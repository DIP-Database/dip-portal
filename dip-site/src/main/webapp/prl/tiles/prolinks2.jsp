     ...
     <td class="TDM fqb" width="50%">      
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="fstrh">
	     ...
	     <p style="white-space: nowrap;">
               <input style="width:325px" type="text" name="input" maxlength="128" value="Rv0304c" id="query"/>&nbsp;
	       ...
	       <input type="hidden" name="debugOn" value="true" id="debugOn"/>
               ...
               &nbsp;&nbsp;&nbsp;<a onclick="YAHOO.mbi.modal.help( 'Query syntax', 'pl_help_solr_search' ); return false" 
                                     href="">Help</a>; <a href="page?id=pl_tutorial">Tutorial</a>
             </p>

	    <p>
              Enter names, functional keywords, and/or 
              <a onclick="YAHOO.mbi.modal.help( 'Protein Identifiers', 'pl_help_pid' ); return false" 
                    href="">public identifiers </a> associated with a protein.
              <a onclick="YAHOO.mbi.modal.help( 'Query syntax', 'pl_help_solr_search' ); return false" 
                    href="">Click here</a> for tips
              on how to refine your search by using 
              wildcards, operators, and special characters.
            </p>
	   </td>
         </tr>

         <tr>
           <td class="ftfoot" align="left" valign="bottom">
             For protein sequence submissions and other useful options
             <a href="page?id=pl_query">try the Advanced Searches.</a>
           </td>
         </tr>		      
