    ...
    <tr>
     ...
     <td class="menu1" nowrap="nowrap">
      <a onmouseover="this.className='MON'" onmouseout="this.className='MOFF'" 
         class="topmenulink" href="page?id=data">DIP Data</a>
     </td>
     <td class="menu1" nowrap="nowrap">
      <a onmouseover="this.className='MON'" onmouseout="this.className='MOFF'" 
     ...
     <td class="menu1" nowrap="nowrap">
      <a onmouseover="this.className='MON'" onmouseout="this.className='MOFF'" 
         class="topmenulink" href="prolinks.jsp">ProLinks</a>
     </td>
     <td class="menu1" nowrap="nowrap">
      <a onmouseover="this.className='MON'" onmouseout="this.className='MOFF'" 
     ...
     <td class="menu1" nowrap="nowrap">
      <a onmouseover="this.className='MON'" onmouseout="this.className='MOFF'" 
         class="topmenulink disabled" >Preferences</a>
     </td>

     <s:set name="itemon" value="#session['USER_ROLE'].keySet().{? #this in {'administrator'}}.size > 0"/>
     <s:if test="#itemon">
      <td class="menu1" nowrap="nowrap">
       <a onmouseover="this.className='MON'" onmouseout="this.className='MOFF'" 
          class="topmenulink" href="page?id=admin">Site Manager</a>
      </td>
     </s:if>
