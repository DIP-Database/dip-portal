 ...
 <tr>
  <td>
   <table width="100%" class="edit_menu_body" >
    <tr>
     <td width="2%" align="center" class="edit_menu_label">Label</td>
     <td>
    ...
    <tr>
     <td width="2%" align="center" class="edit_menu_label">Link</td>
     <td>
    ...
    <tr>
     <td width="2%" align="center" class="edit_menu_label">Disabled</td>
     <td align="left">
<!--
      <s:textfield theme="simple" name="item.active" disabled="true"
                   value="%{#item.active}" size="75" maxlength="75" />
-->
      <s:checkbox theme="simple" name="item.disabled" value="%{#item.disabled}" fieldValue="true"/>
