...
<%@ taglib prefix="s" uri="/struts-tags" %>
  <tr>
    <td>
      ...
      <s:set name="commonname" value="summary.xrefList.xref.{?#this.typeAc=='dxf:0007'}[0].node.name"/>
...
--><br />      <b>EntrezGene:</b>
      <s:iterator value="summary.xrefList.xref.{?#this.ns=='entrezgene'}" id="ext" status="status">
        <s:if test="#status.last">
           <t:insertDefinition name="externallink"/>
        </s:if>
        <s:else>
