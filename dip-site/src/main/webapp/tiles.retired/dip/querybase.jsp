...
<s:if test='rtp=="N"'>
    <tr>
     <td>
      ...
      <td><b>UniProt:</b>
   <s:iterator value="summary.xrefList.xref.{?#this.ns=='UniProt'}" id="ext" status="status">
      ...
      <br />
      <b>RefSeq:</b>
   <s:iterator value="summary.xrefList.xref.{?#this.ns=='RefSeq'}" id="ext" status="status">
      <s:if test="#status.last">
         <t:insertDefinition name="externallink"/>
      </s:if>
      <s:else>
...
<!--   <ol class="int_list">
   <s:iterator value="summary.partList.part" id="mol" status="status">
...
<s:elseif test='rtp=="X"'>
    <tr>
     <td>
   <s:set name="int_ac" value="summary.xrefList.xref.{?#this.typeAc=='dxf:0021'}[0].ac"/>
   ...
   <s:iterator value="summary.xrefList.xref.{?#this.typeAc=='dxf:0015'}" id="ext" status="status">
      <s:if test="#status.last">
         <t:insertDefinition name="externallink"/>
      </s:if>
      <s:else>
...
<s:elseif test='rtp=="S"'>
    <tr>
     <td>
      ...
      <br />
      <b>PubMed:</b>
   <s:iterator value="summary.xrefList.xref.{?#this.typeAc=='dxf:0009'}" id="ext" status="status">
      <s:if test="#status.last">
         <t:insertDefinition name="externallink"/>
      </s:if>
      <s:else>
