...
<h1>Sign up for full access to DIP</h1>
<table width="98%">
 <tr>
  <td align=left>
   <font size=-2>
 ...
 <tr>
  <td align="center">
   <table width="98%" class="form_descr">
    <tr>
     <td align="left">
         You must register and accept DIP's
         <A HREF="http://dip.doe-mbi.ucla.edu/dip/termsofuse.html">Terms&nbsp;of&nbsp;Use</A>
         to gain full (free) access to DIP file downloads.
         We will not share your personal information with any third
         party; the information is for internal use (to gather 
         statistics on database use) only.
     </td>
    </tr>
   </table>
  </td>
           ...
           <table cellpadding="0" cellspacing="0">
            ...
            <tr>
             <td>
              ...
              </script> <%-- 6LfVAwcAAAAAACFlY-X-icWpaoVMxHFyFVu3eIgc --%>
              <noscript>     
