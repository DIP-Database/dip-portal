      ...
      <s:if test="#epos.count==1">
       ...
       <s:if test="tabData.colFld[#cpos.index]=='dtp'">         <%-- dataset column --%>
        ...
        <s:elseif test="tabData.colFld[#cpos.index]=='unc'">   <%-- uncompressed column --%>
         [<A HREF="ftp://">FTP</A>]&nbsp;[<A HREF="file?pt=<s:property value="tabData.data[#entry]['path']"/>&fn=<s:property value="tabData.data[#entry]['file']"/>.<s:property value="tabData.data[#entry]['ext']"/>">HTTP</A>]
        </s:elseif>
        <s:elseif test="tabData.colFld[#cpos.index]=='cmp'">   <%-- compressed column --%>
         [<A HREF="ftp://">FTP</A>]&nbsp;[<A HREF="file?pt=<s:property value="tabData.data[#entry]['path']"/>&fn=<s:property value="tabData.data[#entry]['file']"/>.<s:property value="tabData.data[#entry]['ext']"/>.gz">HTTP</A>]
        </s:elseif>
