...
<script>
  ...
  YAHOO.mbi.news.newsbox = {
    ...
    display: function ( o ) {
      ...
      for( var i=0; i < n; i++) {
        if( i < messages.nbox.length ) {
          ...
          var src = 'news?ret=nbox&year=' + nyr;

          var buildCallback = { cache:false, timeout: 5000,
                                success:YAHOO.mbi.news.newsbox.display,
                                argument:{ id:"newsbox", n:nn, yi:nyi} }; 
    ...
    init : function () {
      ...
      YAHOO.util.Connect.asyncRequest( 'GET','news?ret=ylist', initCallback );

    }
  };

  YAHOO.util.Event.addListener( window, "load",
  YAHOO.mbi.news.newsbox.init());
</script>
