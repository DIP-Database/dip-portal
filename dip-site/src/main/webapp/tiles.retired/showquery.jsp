...
<html lang="en">
 ...
 <head>
  ...
  <script type="text/javascript" language="JavaScript"
          src="/dipdb/dojo/dojo/dojo.js" djConfig="parseOnLoad:true, isDebug:false"></script>

  <script type="text/javascript" language="JavaScript"
          src="/dipdb/js/recstate.js"></script>
...
<s:if test="queryResult!=null">
     <tr>
      <td class="pagebody_record"> 
        <t:insertDefinition name="querybody" />
      </td>
     </tr>
</s:if>
<s:else>
